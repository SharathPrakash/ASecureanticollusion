    ...
    <div id="templatemo_menu">
        <div id="pettabs" class="indentmenu">
            <ul>
                ...
                <li><a href="adminFileDetails.jsp" rel="tab2">File Details</a></li>
                  <li><a href="group_details.jsp" rel="tab3">View Group</a></li>
                  <li><a href="log_details.jsp" rel="tab3">Log Details</a></li>
	...
	<div id="templatemo_content">
        ...
        <div class="templatemo_content_section_01">
            <div class="section_01_left" style="margin-left: 20px;">
                <p style="font-family: cursive; font-size:30px;"><a href="group_details.jsp">View Group</a></p>
                    <p style="font-family: cursive; font-size:30px;"><a href="log_details.jsp">View Log Details</a></p>
                    <p style="font-family: cursive; font-size:30px;"><a href="adminFileDetails.jsp">View File Details</a></p>
