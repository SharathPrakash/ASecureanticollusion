...
<div id="templatemo_container">
    <div id="templatemo_menu">
        <div id="pettabs" class="indentmenu">
            <ul>
                <li><a href="member_login.jsp" rel="tab1" >Home</a></li>
                <li><a href="#" rel="tab6" style="border-right: none;" class="selected">Signature Verification</a></li>
            </ul>
        </div>
	...
	<div id="templatemo_content">
        ...
        <div class="templatemo_content_section_01">
            <div class="section_01_left" style="margin-left: 20px;">
                <p style="font-family: monospace; font-size: xx-large;">Group Signature Verification :</p>
                <div style="margin-left:250px; ">
                    <form action ="sigVerify" method="get">                    
                        ...
                        <p ><input type="submit" value="Submit" style="height:25px;width:100px;font-family: cursive" /> 
                            <input type="reset" value="Cancel" style="height:25px;width:100px;font-family: cursive" /></p>
                        
                    </form>
                    
                     <form action ="getSign" method="post"  target="abc.html">
                        <p style="font-family: fantasy;font-size:160%;">Get Signature Here...</p>
                        <p><input type="submit" value="Click Here..." style="height:25px;width:120px;"></p>
                        </form>
                </div> 
            </div> 
