...
<div id="templatemo_container">
    <div id="templatemo_menu">
        <div id="pettabs" class="indentmenu">
            <ul>
                <li><a href="adminHome.jsp" rel="tab1" >Back</a></li>
            </ul>
        </div>
	...
	<div id="templatemo_content">
        ...
        <div class="templatemo_content_section_01">
            <div class="section_01_left" style="margin-left: 300px;height: 500px;margin-top: 150px;">
                <p style="margin-left:-190px; font-family: monospace;font-size: 15px;font-weight: bold;">Log Details:</p>
                <table  style=" margin-left: -200px;width:80%;position:absolute;">
