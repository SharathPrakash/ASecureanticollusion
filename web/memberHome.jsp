    ...
    <div id="templatemo_menu">
        <div id="pettabs" class="indentmenu">
            <ul>
                ...
                <li><a href="#" rel="tab3">Download</a></li>
	...
	<div id="templatemo_content">
        ...
        <div class="templatemo_content_section_01">
            <div class="section_01_left" style="margin-left: 20px;">
                <p style="font-family: cursive; font-size:30px;"><a href="file_upload.jsp">File Upload</a></p>
                <p style="font-family: cursive; font-size:30px;"><a href="FileDownload.jsp">File Download</a></p>
                    <p style="font-family: cursive; font-size:30px;"><a href="fileDetails.jsp">File Details</a></p>
                    <p style="font-family: cursive; font-size:30px;"><a href="confirm.jsp">A/C Revoke</a></p>
